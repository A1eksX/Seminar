...
# *Пример:*
#
# **Ввод:** пара-ра-рам       рам-пам-папам           па-ра-па-да   # 3фразы
# **Вывод:** Парам пам-пам

# vowels = ['а', 'е', 'ё', 'и', 'о', 'у', 'ы', 'э', 'ю', 'я']
# poem = input('Введите стихотворение: ').split()   # Тарам-парам пурум-бурум пара-ра-рам
# listPhrases = []    # список фраз
# listVowels = []     # список гласных
# numberVowels = 0    # кол-во гласных
# count = 0
# for phrase in poem:
#     listPhrases.append(phrase)
#     for i in str(phrase):
#         for j in vowels:
#             if j == i:
#                 count += 1
#     numberVowels = count
#     count = 0
#     listVowels.append(numberVowels)
# for numbers in range(len(listVowels)):
#     count += listVowels[numbers]
# proverka = count // len(listVowels)
# if proverka != listVowels[0]:
#     print('Пам парам')  # bad
# else:
#     print('Парам пам-пам')  # good
